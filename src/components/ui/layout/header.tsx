...

                {
                    status === 'loading' ? <p>Loading...</p> : !isAuth ? (
                        <>
                            ...
                            <NavbarItem>
                                <Button as={Link} color="secondary" href="#" variant="flat" onPress={() => setIsRegistrationOpen(true)}>
                                    Регистрация
                                </Button>
                            </NavbarItem>
                        </>
                        ...
                        <NavbarItem className="hidden lg:flex">
                            <Button as={Link} href="#" color="secondary" variant="flat" onPress={handleSignOut}>
                                Выйти
                            </Button>
                        </NavbarItem>
                    )
